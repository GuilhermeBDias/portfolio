  ...
  return (
    ...
    >
      ...
      <BentoGrid className="grid-cols-2 lg:grid-cols-2 gap-14 ">
        {experience.map((exp) => (
          <motion.div
  className="col-span-2 lg:col-span-1 row-span-4"
...
>
          ...
          <BackgroundGradient containerClassName=" h-full w-full"
          className=" h-full w-full rounded-2xl"
          shadowClass="blur-sm"
          >
            <BentoGridItem className="absolute inset-0 w-full bg-gradient-to-r from-[#04071D] to-[#0C0E23] border-none pointer-events-none">
              ...
              <div className="flex w-full h-full justify-center items-center">
                <motion.div
                  ...
                  <div className="flex flex-col justify-center items-center h-full w-full gap-2 md:gap-4">
                    ...
                    <motion.p
                      className="w-full text-tertiary font-semibold"
                      variants={itemVariants}
                      >
                      {exp.description}
                    </motion.p>
