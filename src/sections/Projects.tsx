    ...
    <section id="projects" className="section-class flex-col relative mb-10 ">
      ...
      <BentoGrid className="grid-cols-2 lg:grid-cols-3 gap-12 ">
        {ProjectsData.slice(0, visibleProjects).map((project) => (
          <BentoGridItem className="col-span-2 lg:col-span-1 row-span-7 md:row-span-10 border-2 border-[#161935]">
            <Card
              title={project.title}
      ...
      <ModalProjects isOpen={isModalOpen} onClose={() => setModalOpen(false)} project={selectedProject} />
    </section>
  );
}
